...
| ------------------------- | ------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------- |
| `OPENCLAW_CATALOG_URL`    | `https://raw.githubusercontent.com/ExpansionX/WednesdayAI-plugins/main/catalog.json` | Override the remote plugin catalog URL (operator mirror / airgap pinning)        |
| `OPENCLAW_CATALOG_TTL_MS` | `3600000` (1 hour)                                                                   | Remote catalog cache TTL in milliseconds (0 is rejected — falls back to default) |
| `OPENCLAW_CATALOG_REMOTE` | unset (enabled)                                                                      | Set to `"0"` to disable all remote catalog fetching (airgap / mirror mode)       |
