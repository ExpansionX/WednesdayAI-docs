...
You may notice two names around WednesdayAI:

- **WednesdayAI** is the name of the assistant and the product. When the AI talks about itself, its status lines, its help text, or its documentation links, it says WednesdayAI.
- **openclaw** is a technical name that still appears behind the scenes - in file paths, settings files, and commands your administrator runs. That is intentional: it keeps existing setups working, and it does not mean anything changed for you.

Your chats, memories, and files stay exactly where they were. If the AI keeps calling itself by the old name, start a new chat - if it still happens after that, tell your administrator the assistant may be running an outdated version.
