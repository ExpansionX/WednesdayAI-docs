...
- `hooks.maxBodyBytes` sets the maximum accepted request body size. Default `262144` (256 KB). Raise this if you are delivering large webhook payloads (for example, base64-encoded attachments):
