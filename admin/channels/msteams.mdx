...
<Steps>
  ...
  <Step title="Build and upload a Teams app package">
    ...
    <Warning>
      `webApplicationInfo.id` **must** match your Azure Bot App ID exactly. If these values differ, app authentication will fail silently.
    </Warning>
  </Step>
