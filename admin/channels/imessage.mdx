...
|-----|------|---------|-------------|
| `contactMatching.normalizePhoneNumbers` | boolean | `true` | Strip formatting before matching phone numbers |
| `contactMatching.preferEmail` | boolean | `false` | Prefer email handle when a contact has both |
