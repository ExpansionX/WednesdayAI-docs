...
| gog (Gmail CLI)    | ⚠️           | Check [gog releases](https://github.com/steipete/gog/releases) for ARM64 binary; if unavailable, use the [Gmail Pub/Sub webhook](/automation/gmail-pubsub) as a fallback |
