...
|-----|------|---------|-------------|
| `betaHeaders` | string[] | `[]` | Beta feature headers to include in requests |
| `timeoutMs` | integer | `300000` | Request timeout in ms (increase for long reasoning chains) |
| `maxRetries` | integer | `2` | Max retries on transient errors |
