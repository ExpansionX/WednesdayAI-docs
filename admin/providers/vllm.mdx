...
<Note>
The runtime auto-discovers available models via `GET /v1/models`. Ensure your vLLM instance exposes this endpoint (the default). The `--probe-provider` flag validates credentials and connectivity against the named provider without affecting other providers.
</Note>
