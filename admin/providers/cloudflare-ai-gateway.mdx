...
<Note>
  The runtime automatically appends the `/anthropic` suffix if your `baseUrl` does not already end with it. Include it explicitly in the URL to make routing intent clear.
</Note>
