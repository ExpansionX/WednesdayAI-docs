...
| `nvidia/llama-3.1-nemotron-70b-instruct` | NVIDIA fine-tuned Nemotron 70B variant |
| `meta/llama-3.1-nemotron-70b-instruct` | Meta Llama 3.1 Nemotron 70B |
| `nvidia/mistral-nemo-minitron-8b-8k-instruct` | NVIDIA Mistral NeMo Minitron 8B — compact, efficient |
