...
- Opt-in workspace lanes let one persona keep shared persona files while user-specific files resolve
  under per-user lane workspaces. See [Workspace Lanes](/concepts/workspace-lanes).
