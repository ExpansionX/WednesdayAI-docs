...
| ------- | ----------- | ----- |
| `runtime.analysis` | `run(prompt, opts)`, `enqueue(prompt, opts)` | Plugin-owned focused LLM analysis. See [Analysis runtime](/developers/analysis-runtime). |
...
| `runtime.logging` | `getChildLogger(name)`, `shouldLogVerbose()` | Scoped logger and verbosity check |
